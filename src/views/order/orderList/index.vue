 ...
 * @LastEditTime: 2021-01-04 09:29:39
 * @Desc: 订单列表 - page
-->
<template>
  <div class="order-page">
    <searchForm
      btnItems="reset,search,export,other"
      ...
      <div class="listBox">
        <div class="tableBox">
          <el-table :data="tableList" tooltip-effect="dark" style="width: 100%">
            ...
            <el-table-column prop="agentParentName" label="父级代理" min-width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    onExport(data) {
      ...
      const { times, ...otherObj } = data
      let params = otherObj
      params.startDate = times ? times[0] : ''
      params.endDate = times ? times[1] : ''
      console.log('-params-', params)
      exportExcel('order', params)
    },
    // 导出excel代理查看回调
    onOther(data) {
